...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="h-[900px] md:h-[1000px] w-full flex items-center justify-center relative "
    >
      <div className="w-full grid grid-cols-1 mt-32 md:mt-0 md:grid-cols-2 gap-y-16 md:gap-x-8 items-center">
        <div className="w-full h-full flex flex-col justify-center text-center md:text-left">
          <div
            className="absolute left-[-30px] top-1/2 -translate-y-1/2 hidden lg:flex items-center gap-4"
          ...
          <p className="text-lg md:text-xl mb-4">
            I&apos;m a passionate{" "}
            <span className="text-[#adff30] font-bold">
              Full-Stack Developer
            </span>
          </p>

          <p className="max-w-md mx-auto md:mx-0 text-gray-400 leading-7 mb-10">
            An aspiring developer passionate about building high-performance,
          ...
          <div className="flex items-center justify-center md:justify-start gap-6 flex-wrap">
            <Link
              href={
                "https://docs.google.com/document/d/1XRYI3FxZ8OYRCUm1sGoDGiAd9ydMVQXC/export?format=doc"
              }
            >
            ...
            <div className="flex gap-4">
              <a
                href="https://github.com/mgrizqy"
                className="w-[45px] h-[45px] rounded-full border-2 flex items-center justify-center border-[#adff30] hover:bg-[#adff30] hover:text-black transition-all"
              >
                <Github size={22} />
              </a>
              <a
                href="mailto:mgrizqy.work@gmail.com"
                className="w-[45px] h-[45px] rounded-full border-2 flex items-center justify-center border-[#adff30] hover:bg-[#adff30] hover:text-black transition-all"
              >
                <MailIcon size={22} />
              </a>
        ...
        <div className="w-full h-full flex items-center justify-center md:justify-end">
          <div className="relative h-[300px] w-[300px] md:h-[400px] md:w-[400px] ">
            ...
            <Image
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] md:w-[350px] md:h-[350px] bg-[#1d1c22] rounded-full object-cover"
            />
      ...
      <a
        href="#about"
        className="absolute -bottom-17 md:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 group"
      >
