...
const ValueCard = ({ icon: Icon, title }: { icon: React.ElementType, title: string }) => {
    ...
    return (
        ...
        <div className='group relative min-h-[67px] w-fit px-8    rounded-xl bg-[var(--darkColor)] overflow-hidden border border-white/10 transition-all duration-300 flex items-center justify-center gap-4 hover:border-[var(--greenYellowish)]/50 '>
